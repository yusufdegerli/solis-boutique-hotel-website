                    ...
                    {sessions.filter(s => s.status === 'active').length === 0 ? (
                        ...
                        sessions.filter(s => s.status === 'active').map(session => (
                            <div
                                ...
                                className={`p-4 border-b border-gray-100 cursor-pointer hover:bg-white transition-colors ${selectedSession === session.id ? 'bg-white border-l-4 border-l-[var(--gold)]' : ''
                                    }`}
                            >
