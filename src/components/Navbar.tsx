      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-24 items-center">
          ...
          <div className="hidden md:flex space-x-8 items-center">
            ...
            <a href="https://tr.hotels.com/ho3406787680/?semcid=HCOM-TR.UB.GOOGLE.PT-DSA-c-TR.HOTEL&semdtl=a113476951092.b1124944680393.g1aud-2141179518447:dsa-977487782636.e1c.m1EAIaIQobChMI9pqz7faalAMVMJGDBx0OuSHeEAAYASAAEgIKmfD_BwE.r1.c1.j19199051.k19199120.d1660336623510.h1.i1290283925904.l1.n1.o1.p1.q1.s1.t1.x1.f1.u1.v1.w1&gad_source=1&gad_campaignid=13476951092&gbraid=0AAAAACTxZ9aqJKDc7BRD1l2afq77K6U9T&gclid=EAIaIQobChMI9pqz7faalAMVMJGDBx0OuSHeEAAYASAAEgIKmfD_BwE" target="_blank" rel="noopener noreferrer" className="bg-[var(--gold)] text-white px-8 py-3 rounded-full font-serif text-xs uppercase tracking-widest hover:bg-white hover:text-[var(--off-black)] transition-all shadow-lg hover:shadow-xl duration-300 transform hover:-translate-y-0.5">
              {t('book')}
            </a>
          </div>
